...
class DeveloperProjectsAdapter extends BaseAdapter{
    Context context;
    List<ProjectModel>  projectModels;
    public DeveloperProjectsAdapter(Context context, List<ProjectModel> projectModelList) {
        this.context=context;
        this.projectModels=projectModelList;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        final ProjectModel pm=projectModels.get(i);

        view= LayoutInflater.from(context).inflate(R.layout.developerprojectsrow,null);
     ...
     //   Button btsubmit=view.findViewById(R.id.btsubmit);
        ...
        tvprojectname.setText(pm.getProjectname());
        tvprojectdesc.setText(pm.getProjectdesc());
        tvstartdate.setText(pm.getStartdate());
        tvenddate.setText(pm.getEnddate());
    ...
    private void assignProjectdialog(final ProjectModel pm) {
        // custom dialog
   ...
   final Spinner spinner=dialog.findViewById(R.id.spemps);
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET, Constants.getDeveloper+"?developer=tester", new Response.Listener<String>() {
            @Override
