        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Constants.userLogin, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Store.userDetails(getApplicationContext(),id,empid,role);
                    if(role.equalsIgnoreCase("developer")){
                       Intent i = new Intent(getApplicationContext(), Developer_Success1.class);
                        finish();
                        startActivity(i);

                    }else {
                        ToastHelper.toastMsg(getApplicationContext(),"login success");
                       Intent i = new Intent(getApplicationContext(), Developer_success.class);
                       finish();
                        startActivity(i);
